...
map_clevercloud_redis_env() {
  export DISCOURSE_REDIS_HOST="${DISCOURSE_REDIS_HOST:-${REDIS_ADDON_HOST:-}}"
  export DISCOURSE_REDIS_PORT="${DISCOURSE_REDIS_PORT:-${REDIS_ADDON_PORT:-}}"
  export DISCOURSE_REDIS_PASSWORD="${DISCOURSE_REDIS_PASSWORD:-${REDIS_ADDON_PASSWORD:-}}"
}
